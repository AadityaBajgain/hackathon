...
const Display = ({ quizData }) => {
  ...
  return (
    <div className="w-full max-w-screen-md mx-auto mt-5 mb-3 p-4 sm:p-6 md:p-8 bg-[#161515] rounded-lg">
      <div className="flex-grow flex flex-col items-center justify-center p-6 bg-[#161515] rounded-lg">
        {currentQuestion && (
          <>
        ...
        {isSubmitted && (
          <div className="mt-6 text-center text-white">
            <hr />
            <p className="text-xl font-semibold mb-4 mt-4">Your Score: {score} / {parsedQuizData.length}</p>
            {parsedQuizData.map((quiz, index) => {
              ...
              return (
                <div key={index} className="mb-4">
                  <hr />
                  <p className='mt-4'>{quiz.question}</p>
